    ...
    <div class="container">
                    ...
                    <div class="under-lang">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12 usernav">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li class="dropdown">
                                    <a href="#" style="padding: 0px;" class="dropdown-toggle" data-toggle="dropdown"
                                       role="button" aria-haspopup="true" aria-expanded="false"><span
                                                class="glyphicon glyphicon-user" style="color:#E28D33"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a style=""
                                               href="{{ route('myprofile') }}">{{Lang::get('app.My Account')}}</a></li>
                                        <li><a style=""
                                               href="{{ url('viewprofile') }}">{{Lang::get('app.My Profile')}}</a></li>
                                        <li><a style=""
                                               href="{{ url('admin/dashboard') }}">{{Lang::get('app.Dashboard')}}</a>
                                        </li>
                                        <li><a style="" href="{{ route('myoders') }}">{{Lang::get('app.My Orders')}}</a>
                                        </li>
                                        <li><a style="" href="{{ url('logout') }}">{{trans('app.logout')}}</a></li>

                                    </ul>
                                    <a class="bold-11" href="#" style="margin: 0px;color: black;padding: 0px;"><span
                                                style="    font-size: 12px;">{{ Auth::user()->username}}</span></a>
                                </li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a style=""
                                               href="{{ url('viewprofile') }}">{{Lang::get('app.My Profile')}}</a></li>
                                        <li><a style=""
                                               href="{{ route('mydashboard') }}">{{ Lang::get('app.Dashboard')}}</a>
                                        </li>
                                        <li><a style="" href="{{ route('myoders') }}">{{Lang::get('app.My Orders')}}</a>
                                        </li>
                                        <li><a style="" href="{{ url('logout') }}">{{trans('app.logout')}}</a></li>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav">
                ...
                <?php if($t->alias == "shop"){?>
                <li id="{{Active::pattern($t->name, 'current-page')}}"><a href="{{ route('shophome') }}"
                                                                          class="home-menu"><span>{{ Lang::get("app.$t->name")}}</span>
                    </a></li>
                <?php } ?>
                <?php if($t->alias == "event"){?>
                <li id="{{Active::pattern($t->name, 'current-page')}}"><a
                            href="{{ route('eventshome') }}"><span>{{ Lang::get("app.$t->name")}}</span> </a></li>
                <?php } ?>
                <?php if($t->alias == "travel"){?>
                <li id="{{Active::pattern($t->name, 'current-page')}}"><a
                            href="{{ route('travelhome') }}"><span>{{ Lang::get("app.$t->name")}}</span> </a></li>
                <?php } ?>
                <?php if($t->alias == "magazine"){?>
                <li id="{{Active::pattern($t->name, 'current-page')}}"><a
                            href="{{ route('magazinehome') }}"><span>{{ Lang::get("app.$t->name")}}</span> </a></li>
                <?php } ?>

            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 filter-range-price no-padding">
                <div class=".col-sm-9 no-padding">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <select id="country" class="form-control"
                                    style="padding-right: 0px; margin-left: 15px; margin-top: -6px">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <label for="username" class="control-label" style="margin-left: -35px">Nombre de
                                piece</label>
                        </div>
                        <div class="col-sm-1">
                            <select id="country" class="form-control"
                        ...
                        <div class="col-sm-1" style="width: 100px">
                            <input type="text" name="username" class="form-control"
                                   style="margin-top: -32px;margin-left: -36px"
                                   placeholder="" autofocus>
                            <input type="text" name="username" class="form-control"
                                   style="margin-top: -35px; margin-left: 56px"
                                   placeholder="" autofocus>
                        </div>
                    </div>
                    <br>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p class="card-description"><strong>Bootstrap Thumbnail</strong> Customization Example. Here
                                are customized <strong>bootstrap cards</strong>. We just apply some box shadow and
                                remove border radius.</p>

            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9">
                    ...
                    <div class="post">
                        ...
                        <p class="p-style3"><?php echo $product->teaser;?></p>
                        <p class="p-style3"><?php echo $product->description;?></p>
                        <footer>
                            ...
                            <ul class="meta">
                                ...
                                <li><i class="fa fa-user"></i><a href="profile.html"><?php echo $product->user->username; ?></a></li>
                               ...
                               <?php $prodattributes = \Illuminate\Support\Facades\DB::table('product_attributes')->where('product_id','=',$product->id)->get();?>
                                <?php } ?>

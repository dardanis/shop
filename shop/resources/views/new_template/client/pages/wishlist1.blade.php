                        ...
                        <table class="items-list">
                            ...
                            <?php $slug_prod=$prodid->slug;?>
                                ...
                                <tr class="item first">
                                    ...
                                    <td class="price-value" style="width:30%;">CHF <span style="padding-left: 5px"></span> {!! $product->price !!}</td>
                                    {!! Form::open(array('method' => 'POST', 'route' => array('add_cart_wishlist', $product->id))) !!}
                                    <td class="button" sty;e="width:10%;"><button class="btn btn-primary btn-sm"><i class="icon-shopping-cart"></i>Add To cart</button></td>
                                    {!! Form::close() !!}

...
<?php $user_id=$user['id'];?>
<?php }?>
    <a href="#" class="toggle-category" id="<?php echo $c->id;?>" style="color:#6ADAA2;text-decoration: none;font-size:20px;">-</a>
    <a style="color:#6ADAA2" href="{{ route('productscategory') }}?cat_id=<?php echo $c->id;?>&&user_id=<?php echo $user_id;?>"><?php echo $c->name;?></a><span style="float:right">(<?php echo sizeof($products);?>)</span>
<style>
    .toggle_subcategory{
        display:none;
    }
    ...
    <ul class="toggle_subcategory" id="toggle_subcategory_<?php echo $c->id;?>" style="padding-left: 20px;">
                ...
                <?php $sub_category_id=$sc->id;?>
                    ...
                    {?>
                            ...
                            <?php } else {?>
                                    <li>
                                        <a href="{{ route('productscategory') }}?cat_id=<?php echo $c->id;?>&&subcategory=<?php echo $sc->id;?>&&user_id=<?php echo $user_id;?>" style="color:rgb(106, 218, 162);"><?php echo $sc->name;?></a><span style="float:right;">(<?php echo sizeof($productssubcategory);?>)</span>
                                    </li>
                                    <?php } ?>
                                        <ul>
                                            ...
                                            {?>
                                                ...
                                                <li style="width:100%;padding:0px;">
                                                    <a  class="sub-open" href="{{ route('productscategory') }}?cat_id=<?php echo $c->id;?>&&subcategory=<?php echo $sc->id;?>&&subsub=<?php echo $ssc->id;?>&&user_id=<?php echo $_GET['user_id'];?>" style="color:rgb(106, 218, 162);"><?php echo $ssc->name;?></a><span style="float:right;">(<?php echo sizeof($productssubsub);?>)</span>
                                                </li>
                                                <?php } else { ?>
                                                <li style="width:100%;padding:0px;">
                                                    <a  href="{{ route('productscategory') }}?cat_id=<?php echo $c->id;?>&&subcategory=<?php echo $sc->id;?>&&subsub=<?php echo $ssc->id;?>&&user_id=<?php echo $user_id;?>" style="color:rgb(106, 218, 162);"><?php echo $ssc->name;?></a><span style="float:right;">(<?php echo sizeof($productssubsub);?>)</span>
                                                </li>
                                                <?php  }?>
                                            <?php }?>
                                        </ul>

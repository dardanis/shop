            ...
            <div  class="col-md-12" style="padding-left: 0px">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title"> {{ Lang::get("app.Gallery")}}</div>
                    </div>
                    <div class="panel-body" >
                        ...
                        <h3> <span id="photoCounter"></span></h3>
                            ...
                            @foreach($product->pictures as $img)
                                <div class="box img-responsive col-md-3" style="margin-bottom: 20px">
                        ...
                        <div class="dropzone-previews" id="dropzonePreview"></div>
                            ...
                            <h4 style="text-align: center;color:#ffaa00;">{{trans('shop.drop_images')}}<span class="glyphicon glyphicon-hand-down"></span></h4>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-8">
                                <input type="hidden" id="token" value="{{ csrf_token() }}">
                                <div class="col-md-6">
                                    <a href='{{ url("product/product_attributes/$product->slug/$product->id") }}' class="btn btn-success">{{ Lang::get('app.Next') }}</a>
                                </div>

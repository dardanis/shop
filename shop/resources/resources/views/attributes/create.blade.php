            ...
            <div class="col-md-9">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        {!! Form::open(['url' => route("attributes",array($category->slug,$category->id)), 'class' => 'form-horizontal', 'files'=>true, 'id'=>'real-dropzone']) !!}
                        ...
                        <div class="form-group">
                            {!! Form::label('sub_category_id', trans('shop.sub_category_id') . ' *', ['class' => 'col-sm-2 col-sm-2 control-label' ])!!}
                            <div class="col-lg-10">
                                {!! Form::select('sub_category_id',[null=>'Please Select one category']+$subcategories, '', array(
                        'class'                         => 'form-control',
                        'placeholder'                   => '',
                        'required',
                        'id'                            => 'first',
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-6">
                                ...
                                <div class="col-md-2">
                                    <input type="checkbox" name="related" id="chk-related" value="0"/>Related
                                </div>
                                <div class="col-md-3">

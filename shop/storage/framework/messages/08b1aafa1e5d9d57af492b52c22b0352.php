			...
			<div class="row">
				<div class="col-sm-9 main-content pull-right">
					...
					<div class="beta-products-list">
						<h4><?php echo e(trans('main.allproducts')); ?></h4>
						<div class="beta-products-details">
							<form >
							
							<p class="pull-right">
								<span class="sort-by">Sort by </span>
								<select name="sortby" id="filter-form" class="beta-select-primary">
									<option value="desc">Latest</option>
									<option value="asc">Ascending</option>
									<option value="low">Low to high</option>
									<option value="high">High to low</option>
								</select>
								<input type="hidden" id="token2" value="<?php echo e(csrf_token()); ?>">
							</p>
							</form>
							<div class="clearfix"></div>
						</div>
						<div id="prod"> 
						<?php foreach(array_chunk($products->getCollection()->all(),3) as $row): ?>
						<div class="row">

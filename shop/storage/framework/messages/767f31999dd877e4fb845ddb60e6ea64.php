    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
				<?php echo Form::model($product, array('class'=>'form-horizontal tasi-form','method' => 'PATCH','files'=>true ,'route' => array('product_put', $product->id))); ?>
				...
				<div class="form-group">			
					...
					<?php echo link_to_route('client_products', 'Cancel', array(), array('class' => 'btn btn-danger')); ?>

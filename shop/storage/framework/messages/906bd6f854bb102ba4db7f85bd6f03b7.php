      ...
      <aside>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a class="<?php echo e(Active::route('b_myaccount', 'active')); ?>" href="<?php echo e(url('business/dashboard')); ?>">
                          <i class="fa fa-dashboard"></i>
                          <span>Dashboard</span>
                      </a>
                  </li>
                  <li class="sub-menu">
                      <a class="<?php echo e(Active::route(array('business_products', 'business_products_add'), 'active')); ?>" href="javascript:;" >
                          <i class="fa fa-book"></i>
                          <span>My Products</span>
                      </a>
                      <ul class="sub">
                          <li class="<?php echo e(Active::route('business_products', 'active')); ?>"><a  href="<?php echo e(url('business/b_products')); ?>">All products</a></li>
                          <li class="<?php echo e(Active::route('business_products_add', 'active')); ?>"><a  href="<?php echo e(url('business/add/product')); ?>">Add product</a></li>
                      </ul>
                  </li>
              </ul>
          </div>

                  ...
                  <div class="adv-table">
                      <table  class="display table table-bordered table-striped" id="example">
                       ...
                       <tr >
                          ...
                          <td><?php echo link_to_route('business_edit_products', 'Edit', array($product->slug), array('class' => 'btn btn-warning btn-xs')); ?></td>
                          <td>
                            <?php echo Form::open(array('method' => 'DELETE', 'route' => array('business_product_delete', $product->id))); ?>

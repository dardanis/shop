...
<!--                             <img alt="" src="img/avatar1_small.jpg"> -->
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="<?php echo e(url('admin/profile')); ?>"><i class=" fa fa-suitcase"></i>Profile</a></li>
      ...
      <aside>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a class="<?php echo e(Active::route('admin_dashboard', 'active')); ?>" href="<?php echo e(url('admin/dashboard')); ?>">
                          <i class="fa fa-dashboard"></i>
                          <span>Dashboard</span>
                      </a>
                  </li>
                  <li>
                      <a class="<?php echo e(Active::route('admin_products', 'active')); ?>" href="<?php echo e(url('admin/a_products')); ?>">
                  ...
                  <li class="sub-menu">
                      <a class="<?php echo e(Active::route(array('categoriesindex', 'addcategory'), 'active')); ?>" href="javascript:;" >
                          <i class="fa fa-book"></i>
                          <span>Categories</span>
                      </a>
                      <ul class="sub">
                          <li class="<?php echo e(Active::route('categoriesindex', 'active')); ?>"><a  href="<?php echo e(url('admin/categories')); ?>">All categories</a></li>
                          <li class="<?php echo e(Active::route('addcategory', 'active')); ?>"><a  href="<?php echo e(url('admin/categories/add')); ?>">Add category</a></li>
                      </ul>
                  </li>

                  <li class="sub-menu">
                      <a class="<?php echo e(Active::route(array('users', 'create_users','client_users','business_users'), 'active')); ?>" href="javascript:;" >
                          <i class="fa fa-users"></i>
                          <span>Users</span>
                      </a>
                      <ul class="sub">
                          <li class="<?php echo e(Active::route('users', 'active')); ?>"><a  href="<?php echo e(url('admin/users')); ?>">All users</a></li>
                          <li class="<?php echo e(Active::route('business_users', 'active')); ?>"><a  href="<?php echo e(url('admin/users/business')); ?>">Business users</a></li>
                          <li class="<?php echo e(Active::route('client_users', 'active')); ?>"><a  href="<?php echo e(url('admin/users/clients')); ?>"> Client users</a></li>
                          <li class="<?php echo e(Active::route('create_users', 'active')); ?>"><a  href="<?php echo e(url('admin/users/add')); ?>">Add user</a></li>
                      </ul>
                  </li>
              </ul>
          </div>
